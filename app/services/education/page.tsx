...
import { Shield, ArrowLeft, BookOpen, Check } from 'lucide-react';
...
export default function EducationPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-32 pb-16 bg-gradient-to-br from-emerald-900 via-teal-950 to-emerald-950">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            >
              Capacity building for human rights defenders, legal practitioners, 
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="prose prose-lg max-w-none mb-12">
              <p className="text-gray-600 leading-relaxed">
                CAT Kenya is committed to strengthening the capacity of individuals and organizations 
                working in the human rights field. Our education and training programs provide practical 
                skills and knowledge needed to effectively advocate for and protect human rights.
              </p>
            </motion.div>
            ...
            <motion.div variants={staggerContainer} className="space-y-4">
              {programs.map((program, index) => (
                ...
                >
                  ...
                  <span className="text-lg text-gray-800">{program}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
          ...
          >
            <p className="text-gray-600 mb-6">
              Interested in our training programs? Contact us to learn more.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-full font-semibold hover:shadow-lg transition-all"
            >
              Contact Us
            </Link>
          </motion.div>
