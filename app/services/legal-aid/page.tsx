...
import { Shield, ArrowLeft, Scale, Check } from 'lucide-react';
...
const services = [
  ...
  'Documentation of torture and violations',
  'Assistance with police complaints',
  'Support for reparations claims',
...
export default function LegalAidPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-32 pb-16 bg-gradient-to-br from-blue-900 via-blue-950 to-cyan-950">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            >
              Free legal assistance to ensure justice is accessible to all survivors of torture and human rights violations.
            </motion.p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <motion.div variants={staggerContainer} className="space-y-4">
              {services.map((service, index) => (
                <motion.div 
                  key={index}
                  variants={fadeInUp}
                  className="flex items-center gap-4 p-6 bg-blue-50 rounded-2xl"
                >
          ...
          >
            <p className="text-gray-600 mb-6">
              Need legal assistance? Contact us today for a confidential consultation.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-full font-semibold hover:shadow-lg transition-all"
            >
              Contact Us
            </Link>
          </motion.div>
